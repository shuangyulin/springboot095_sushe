<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="宿舍类型" prop="susheleixing">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="楼栋" prop="loudong">
          <el-input v-model="ruleForm.loudong" 
              placeholder="楼栋" clearable  :readonly="ro.loudong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="楼栋" prop="loudong">
              <el-input v-model="ruleForm.loudong" 
  ...
  data() {
	...
	beizhu : false,
      ...
      rules: {
          ...
          susheleixing: [
                { required: true, message: '宿舍类型不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          loudong: [
