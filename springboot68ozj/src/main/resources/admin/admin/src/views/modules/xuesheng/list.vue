<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('xuesheng','卫生') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','卫生') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','卫生') && contents.tableBtnIcon == 0" type="success" size="mini" @click="weishengjianchaCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'卫生':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','缴费') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'缴费':'' }}</el-button>
                <el-button v-if="isAuth('xuesheng','缴费') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'缴费':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('xuesheng','缴费') && contents.tableBtnIcon == 0" type="success" size="mini" @click="jiaofeixinxiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'缴费':'' }}</el-button>
    ...
    <weishengjiancha-cross-add-or-update v-if="weishengjianchaCrossAddOrUpdateFlag" :parent="this" ref="weishengjianchaCrossaddOrUpdate"></weishengjiancha-cross-add-or-update>
...
import weishengjianchaCrossAddOrUpdate from "../weishengjiancha/add-or-update";
...
export default {
  data() {
    return {
      ...
      weishengjianchaCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    weishengjianchaCrossAddOrUpdate,
  ...
  methods: {
    ...
    weishengjianchaCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.weishengjianchaCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','xuesheng');
      this.$nextTick(() => {
      this.$refs.weishengjianchaCrossaddOrUpdate.init(row.id,type);
      });
    },
    jiaofeixinxiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
