  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiurenyuan'"  label="维修工号" prop="weixiugonghao">
          <el-input v-model="ruleForm.weixiugonghao" readonly              placeholder="维修工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiurenyuan'"  label="姓名" prop="xingming">
      ...
      <el-col :span="24">  
        <el-form-item v-if="flag=='weixiurenyuan'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="weixiurenyuanzhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='weixiurenyuan'"  label="身份证" prop="shenfenzheng">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='shangjia'"  label="地址" prop="dizhi">
...
export default {
  ...
  methods: {
    ...
    weixiurenyuanzhaopianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.weixiugonghao)&& 'weixiurenyuan'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'weixiurenyuan'==this.flag){
      ...
      if( 'weixiurenyuan' ==this.flag && this.ruleForm.shenfenzheng&&(!checkIdCard(this.ruleForm.shenfenzheng))){
