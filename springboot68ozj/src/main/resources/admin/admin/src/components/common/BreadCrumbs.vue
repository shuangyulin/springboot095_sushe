<template>
  <el-breadcrumb class="app-breadcrumb" separator="⭐" style="height:50px;backgroundColor:rgba(187, 255, 255, 1);borderRadius:20px;padding:;boxShadow:;borderWidth:2px;borderStyle:;borderColor:rgba(255, 215, 0, 1);">
    ...
    breadcrumbStyleChange(val) {
      this.$nextTick(()=>{
        ...
        document.querySelectorAll('.app-breadcrumb .el-breadcrumb__inner .no-redirect').forEach(el=>{
          el.style.color = "rgba(238, 130, 238, 1)"
        })
